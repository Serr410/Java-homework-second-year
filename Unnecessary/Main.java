    ...
    public static void main(String[] args) {
        ...
        switch (lab) {
            ...
            case "4" -> {
                ...
                Utilities tester1 = (Utilities) List.<String>of("asd", "afsdg", "agehdad");
                Utilities tester2 = (Utilities) List.<Integer>of(1, -3, 7);
                Utilities tester3 = (Utilities) Arrays.asList(
                        new int[]{1, 2, 3},
                        new int[]{4, 5},
                        new int[]{6, 7, 8, 9});
                System.out.println();
