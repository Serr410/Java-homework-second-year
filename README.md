...
Решение
 1. Создать интерфейс, являющийся аннотацией Invoke.
 2. Создать класс, содержащий в себе метод с этой аннотацией.
 3. Создать класс для работы с методами под аннотацией.
...
Решение
 1. Создать интерфейс, являющийся аннотацией ToString.
 2. Создать класс, содержащий в себе метод с этой аннотацией.
 3. Создать класс для работы с методами под аннотацией.
...
Решение
 1. Создать интерфейс, являющийся аннотацией Validate.
 2. Создать класс, содержащий в себе метод с этой аннотацией.
 3. Создать класс для работы с методами под аннотацией.
...
Решение
 1. Создать интерфейс, являющийся аннотацией Two.
 2. Создать класс, содержащий в себе метод с этой аннотацией.
 3. Создать класс для работы с методами под аннотацией.
...
Решение
 1. Создать интерфейс, являющийся аннотацией Cache.
 2. Создать класс, содержащий в себе метод с этой аннотацией.
 3. Создать класс для работы с методами под аннотацией.
...
Решение
 1. Использовать интерфейс Default, созданный ранее.
 2. Создать класс, содержащий в себе методы проверки работы обработчика интерфейса.
